...
$u = Catalyst::SmartURI->new('sip:phone@domain.ext?Subject=Meeting&Priority=Urgent');
...
$u = Catalyst::SmartURI->new('sip:phone@domain.ext;maddr=127.0.0.1;ttl=16');
print "not " unless $u->host eq 'domain.ext' &&
...
$u = Catalyst::SmartURI->new_abs('sip:phone@domain.ext', 'sip:foo@domain2.ext');
print "not " unless $u eq 'sip:phone@domain.ext';
print "ok 9\n";

$u = Catalyst::SmartURI->new('sip:phone@domain.ext');
